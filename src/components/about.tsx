    ...
    return(
        <div id="about" className="ml-6 max-xs-screen:ml-6 sm:ml-10 text-zinc-800">
            <div className="flex flex-col">
                <h1 className="text-4xl max-xs-screen:text-2xl max-sm:text-2xl max-lg:text-3xl">About me</h1>
                <p className="ml-4 mt-2 text-lg max-xs-screen:text-sm max-xs-screen:ml-1 max-xs-screen:mr-2 max-xs-screen:w-auto max-sm:ml-3 max-sm:text-md max-sm:mt-2 max-lg:w-[50rem] break-words">
                ...
                <h4 className="text-xl mt-4 font-bold max-xs-screen:text-base max-xs-screen:ml-1 max-sm:ml-3 max-sm:text-lg max-lg:text-1xl">Here are my socials</h4>
                <Socials />
            </div>
        </div>
    )
