    ...
    return(
        <div id="about" className="ml-6 max-xs-screen:ml-6 sm:ml-10 text-zinc-800">
            <div className="flex flex-col">
                ...
                <p className="ml-8 mt-4 w-3/6 text-lg max-xs-screen:text-sm max-xs-screen:ml-1 max-xs-screen:mr-2 max-xs-screen:w-auto max-sm:ml-3 max-sm:text-md max-sm:mt-2 max-lg:w-[50rem] break-words">
                ...
                <h4 className="ml-4 text-xl mt-4 font-bold xs-screen:text-md xs-screen:ml-1 sm:ml-3 sm:text-lg lg:text-1xl">Here are my socials</h4>
                <Socials />
            </div>
        </div>
    )
