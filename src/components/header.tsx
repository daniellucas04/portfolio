...
export default function Header(){
    return(
        <div className='text-zinc-800 w-screen h-screen flex flex-col justify-center items-center'>
            <h1 className="text-7xl">Daniel</h1>
            <h2 className="text-6xl hover:bg-zinc-800 hover:text-zinc-200 cursor-default transition-colors duration-500 p-2">Programmer</h2>
